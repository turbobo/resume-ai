...
export const TEMPLATES = {
  classic: {
    ...
    colors: { primary: '#1a1a2e', accent: '#333', headerBg: '#f8f9fa', text: '#333333', bg: '#ffffff' },
  ...
  modern: {
    ...
    colors: { primary: '#2563eb', accent: '#1d4ed8', headerBg: '#eff6ff', text: '#374151', bg: '#ffffff' },
  ...
  creative: {
    ...
    colors: { primary: '#7c3aed', accent: '#6d28d9', headerBg: '#faf5ff', text: '#1f2937', bg: '#faf5ff' },
    font: { heading: 'font-bold', body: 'font-normal' },
    layout: 'two-column',
  },
  minimal: {
    ...
    colors: { primary: '#000000', accent: '#333', headerBg: '#fafafa', text: '#111827', bg: '#ffffff' },
